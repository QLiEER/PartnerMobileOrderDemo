...
@objc public class QLiEERMobileSDK: NSObject{
    ...
    static let realmMigration:RealmMigration = RealmMigration()
...
//        backgroundPreorderController.stopObserving()
    ...
    @objc static public func getVersion() -> String{
        var version = ""
        if let bundle = Bundle(identifier: "com.qlieer.QLiEERMobileOrderSDK"){
